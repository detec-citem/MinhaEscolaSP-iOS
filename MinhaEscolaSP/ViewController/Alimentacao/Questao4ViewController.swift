...
final class Questao4ViewController: ViewController {
    //MARK: Constants
    fileprivate struct Constants {
        static let opcao1: UInt8 = 13
        static let opcao2: UInt8 = 14
        static let opcao3: UInt8 = 15
        static let opcao4: UInt8 = 16
        static let opcao5: UInt8 = 17
        static let opcao6: UInt8 = 18
        static let opcao7: UInt8 = 19
        static let opcao8: UInt8 = 20
    }
    ...
    @IBAction func irParaConcluirAvaliacao() {
        ...
        var questao4 = [UInt8]()
        if opcao1 {
            questao4.append(Constants.opcao1)
        }
        if opcao2 {
            questao4.append(Constants.opcao2)
        }
        if opcao3 {
            questao4.append(Constants.opcao3)
        }
        if opcao4 {
            questao4.append(Constants.opcao4)
        }
        if opcao5 {
            questao4.append(Constants.opcao5)
        }
        if opcao6 {
            questao4.append(Constants.opcao6)
        }
        if opcao7 {
            questao4.append(Constants.opcao7)
        }
        if opcao8 {
            questao4.append(Constants.opcao8)
        }
        concluirAvaliacaoViewController.questao4 = questao4
